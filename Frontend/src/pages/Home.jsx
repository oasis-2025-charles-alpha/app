...
function Home() {
    const [books] = useState([
        ...
        { id: 2, title: 'JavaScript Basics', author: 'Jane Smith', price: 32.50, condition: 'Like New', imageUrl: 'https://via.placeholder.com/200x250' },
        { id: 3, title: 'CSS Mastery', author: 'Mike Johnson', price: 28.75, condition: 'Used', imageUrl: 'https://via.placeholder.com/200x250' },
